                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="img-profile">
                                <img src="{{ asset($customer->foto ? 'images/' . $customer->foto : 'https://placehold.co/150x150') }}"
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    <label for="" class="form-label">Sim Number</label>
                                    <input type="text" name="email" value="{{ $customer->sim_number }}"
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md">
                                    ...
                                    <textarea name="address" id="" class="form-control" cols="30" rows="10">{{ $customer->address }}</textarea>
                                </div>
                            </div>
                            <div class="btn-cta mt-3 d-flex">
                                <a href="{{ route('editProfile.edit', $customer->id) }}"
