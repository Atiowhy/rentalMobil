        ...
        <div class="container">
            <div class="row">
                <div class="col-md">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('editProfile.update', $data->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="img-profile gap-3 d-flex justify-content-start align-items-center">
                                    <img src="{{ asset($data->foto ? 'images/' . $data->foto : 'https://placehold.co/150x150') }}"
                                        alt="" class="mr-3 rounded-3" width="150" height="150">
                                    <input type="file" name="foto" class="form-control w-50">
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="sim_number" value="{{ $data->sim_number }}"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="row mt-3">
