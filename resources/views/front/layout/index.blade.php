        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-start" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="{{ route('orderUser.index') }}" class="nav-link">Orders</a></li>
                </ul>
            </div>

            <div class="img-profile d-flex justify-content-center align-items-center">
                <img src="{{ asset('images/' . session('foto')) }}" width="50" height="50"
                    class="rounded-circle mr-3" alt="">
                <div class="username d-flex justify-content-center align-items-center ms-2">
                    <a href="{{ route('editProfile.index') }}"
                        class="text-white mb-0">{{ session('customer_name', 'Guest') }}
                    </a>
                </div>
            </div>
                        ...
                        <div class="col-md-12 d-flex align-items-center">
                            <div class="services-wrap rounded-right w-100">
                                ...
                                <p class="d-flex justify-content-center">
                                    <a href="{{ route('order.index') }}" class="btn btn-primary py-3 px-4"
                                        data-bs-toggle="modal" data-bs-target="#exampleModal">Reserve Your Perfect
                                        Car</a>
                                </p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row no-gutters">
                <div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                    style="background-image: url({{ asset('assets/front/images/about.jpg') }});">
                </div>
            ...
            <div class="row d-flex">
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry justify-content-end">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url({{ asset('assets/front/images/image_1.jpg') }});">
                        </a>
                        <div class="text pt-4">
                            <div class="meta mb-3">
                ...
                <div class="col-md-4 d-flex ftco-animate">
                    <div class="blog-entry">
                        <a href="blog-single.html" class="block-20"
                            style="background-image: url({{ asset('assets/front/images/image_3.jpg') }});">
                        </a>
                        <div class="text pt-4">
                            <div class="meta mb-3">
                                <div><a href="#">Oct. 29, 2019</a></div>
