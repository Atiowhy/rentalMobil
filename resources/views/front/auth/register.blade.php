                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="{{ route('actionRegisCustomer') }}"
                                        method="post">
                                        @csrf
                                        <div class="col-12">
                                        ...
                                        <input type="hidden" name="sim_number" value="0" class="form-control"
                                            id="yourName">
                                        <input type="hidden" name="address" value="0" class="form-control"
                                            id="yourName">
                                        <input type="hidden" name="foto" value="0" class="form-control"
                                            id="yourName">
